...
let message; // trying to assigning a number to stirng
// message=5
...
// ---------------------------------------------------------------------------------------------------
// 7. Logical Gates
let aa = true, bb = false, cc = true; // a , b are already declared
...
// ---------------------------------------------------------------------------------------------------
// 11. Grading System
let score = 88; // number type annotation
let grade; // string type annotation
grade =
    score >= 90
        ? "Your grade is 'A'"
        : score >= 80
...
let leapYear; // declare a variable
let year = 2020;
